...
DROP POLICY IF EXISTS "Allow authenticated full access to warehouses" ON public.warehouses;
...
DROP POLICY IF EXISTS "Allow authenticated full access to inventory_logs" ON public.inventory_logs;
...
CREATE TRIGGER update_inventory_modtime BEFORE UPDATE ON public.inventory_items
    FOR EACH ROW
