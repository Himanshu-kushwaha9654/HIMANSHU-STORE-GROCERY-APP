...
import { EXTENDED_RECIPES_2 } from './recipes-extended-2';
...
export const MOCK_RECIPES: Record<string, Recipe> = {
  "paneer-butter-masala": {
    ...
    servings: "4",
    rating: "4.9",
    img: "/images/recipes/paneer_butter_masala.png",
  ...
  "chole-bhature": {
    ...
    servings: "4",
    rating: "4.9",
    img: "/images/recipes/chole_bhature.png",
...
export const RELATED_RECIPES = Object.values(MOCK_RECIPES).slice(0, 4);
